...
const Introduction: React.FC<IntroductionProps> = ({
  ...
  return (
    <>
      <p className="mb-8 text-2xl font-bold text-center tracking-[.01em]">
        實驗參與同意書
      </p>
      ...
      <p className="mb-4 text-xl leading-relaxed tracking-[.01em]">
        實驗地點為管理學院教研館 114A 網際網路資訊行為實驗室，我們將請您使用本實驗室的電腦進行影片觀賞的實驗，您在實驗過程中如有任何疑慮可以隨時終止，試驗過程中或是結束後若有任何問題歡迎隨時聯繫研究人員。完成本實驗總計約 20-30 分鐘，實驗分成以下 3 個部分：
      </p>
      <ol className="list-decimal list-inside mb-4 text-xl leading-relaxed tracking-[.01em]">
        <li className="mb-3">
          影片觀賞：請您觀看 2 部運動影片與 2 部寵物影片，影片中會跳出廣告，請您完整觀看每一部影片並填寫相關問題，預計花費 15-20 分鐘。
        </li>
        <li className="mb-3">
          影片觀賞體驗調查：請您根據上述 4 部影片的觀看體驗回答問題，預計花費 2-3 分鐘。
        </li>
        <li>
          基本資料與社群影音使用調查：請您填寫個人基本資料與日常觀看社群影音的問題，預計花費 2-3 分鐘。
        </li>
      </ol>
      <p className="mb-4 text-xl font-bold tracking-[.01em]">
        費用與獲益
      ...
      <p className="mb-4 text-xl leading-relaxed tracking-[.01em]">
        本研究不會向您收取任何費用，亦不會有任何獲益。為了感謝與補償您參與本實驗所花費的時間與精神，若您全程參與實驗，實驗結束後您會獲得現金 100 元新台幣。
      </p>
      <p className="mb-4 text-xl font-bold tracking-[.01em]">
        隱私
      </p>
